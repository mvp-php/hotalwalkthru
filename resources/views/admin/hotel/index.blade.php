            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Hotel List</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        function deleteswal(id) {
            swal({
			  ...
			  confirmButtonText: 'Yes'
				...
				if (!isConfirm) return;
                                window.location.href="<?php echo URL::to('/');?>/hotel-delete?id=" + id;
			})
        }
		function AccountActiveOrDeactive(id,val) {
			if(val ==1){
				var msg  =' account deactive  permanently?';
			}else{
				var msg  ='account active  permanently?';
			}
            swal({
                title: 'Are you sure?',
			  text: msg,
			  ...
			  confirmButtonText: 'Yes'
				...
				if (!isConfirm) return;
                                window.location.href="<?php echo URL::to('/');?>/accountActiveOrDeactive?id=" + id+"&status="+val;
			})
        }
    </script>
