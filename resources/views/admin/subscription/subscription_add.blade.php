                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form id="main_id" method="post" action="<?php echo URL::to('/'); ?>/subscriptioninsert" novalidate enctype="multipart/form-data">
                                        <input type='hidden' name='_token' value='<?php echo csrf_token(); ?>'>

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Plan Name<span style="color:red">*</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="plan_name" id="plan_id" placeholder="Enter plan name" value="{{old('plan_name')}}">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="duration" id="duration_id" placeholder="Enter duration" value="{{old('duration')}}">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="price" id="price_id" placeholder="Enter price" value="{{old('price')}}">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control editor1" name="description" id="description_id" placeholder="Enter description" value="">{{old('description')}}</textarea>
