            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Subscription List</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Subscription List</h5>
                          <a href="<?php echo URL::to('/'); ?>/subscriptionAdd" class="btn btn-primary" style="float:right"><i class="fa fa-plus"></i>Add New Category</a>-->
                        </div>
        ...
        function deleteswal(id) {
            swal({
			  ...
			  confirmButtonText: 'Yes'
				...
				if (!isConfirm) return;
                                window.location.href="<?php echo URL::to('/');?>/subscriptionDelete?id=" + id;
			})
        }
