                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form id="main_id" method="post" action="<?php echo URL::to('/'); ?>/category-insert" novalidate enctype="multipart/form-data">
                                        <input type='hidden' name='_token' value='<?php echo csrf_token(); ?>'>

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Category Name<span style="color:red">*</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="category_name" id="category_id" placeholder="Enter title" value="{{old('category')}}">
