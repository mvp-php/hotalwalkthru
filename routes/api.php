...
Route::get('/v1/hotelDashboard', 'API\v1\ServiceController@hotelDashboard');
Route::get('/v1/categoryWiseVideoLikeView', 'API\v1\ServiceController@categoryWiseVideoLikeView');


Route::get('/v1/countryList', 'API\v1\ServiceController@countryList');
Route::POST('/v1/rankOfHotel', 'API\v1\ServiceController@rankOfHotel');
Route::POST('/v1/totalHotelVideo', 'API\v1\ServiceController@totalHotelVideo');
Route::POST('/v1/totalHotelFollowers', 'API\v1\ServiceController@totalHotelFollowers');
Route::POST('/v1/totalHotelProfile', 'API\v1\ServiceController@totalHotelProfile');
Route::POST('/v1/hotelVideoanlytic', 'API\v1\ServiceController@hotelVideoanlytic');
Route::POST('/v1/hotelFollowUnFollow', 'API\v1\ServiceController@hotelFollowUnFollow');
Route::POST('/v1/hotelFollowUnFollowBycountry', 'API\v1\ServiceController@hotelFollowUnFollowBycountry');
Route::get('/v1/hotelDetailsPer', 'API\v1\ServiceController@hotelDetailsPer');
/*end Hotel side web services************************************************/
Route::get('/v1/slider', 'API\v1\ServiceController@slider');